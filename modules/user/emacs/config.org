...
#+begin_src emacs-lisp
  ...
  (nj/leader-keys
    ...
    "C-f" '(nj/find-file :wk "Find File")
    "C-c" '(nj/compile :wk "Compile")
    "C-r" '(nj/recompile :wk "Recompile")
    "C-s" '(nj/shell-command :wk "Shell Command")
    "C-a" '(nj/async-shell-command :wk "Async Shell Command")
    "C-k" '(nj/force-kill-current-buffer :wk "Force kill the current buffer")
    ...
    "sa"  '(async-shell-command :wk "Async Shell Command")
